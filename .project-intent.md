# Scroll Down Sports — Project Intent
...
- see context before outcomes
- avoid random opinions and noise
- consume games like a story rather than a feed
...
Expand thoughtfully only when it improves experience.
